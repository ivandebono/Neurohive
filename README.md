...
neurohive/
├── assets/
│   └── taxonomy_graph.png         Taxonomy graph visualisation (generated by KnowledgeBase.draw_graph())
│
├── data/
...
│   ├── knowledge_base.py          KnowledgeBase: graph indices, smart_expand(), draw_graph()
